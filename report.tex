...
\definecolor{codeorange}{rgb}{0.84, 0.43, 0}
...
\titlespacing{\chapter}{0pt}{0pt}{1.25ex plus .2ex}
\titlespacing{\section}{0pt}{2.5ex plus 1ex minus .2ex}{1.25ex plus .2ex}
...
\chapter{Conclusion}
\subfile{sections/08-conclusion.tex}

\chapter{Reflective Comments}
\subfile{sections/09-reflective.tex}

\chapter{Appendix}
\subfile{sections/10-appendix.tex}
